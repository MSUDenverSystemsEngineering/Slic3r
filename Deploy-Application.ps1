...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		#Install Slic3r
		Copy-File -Path "$dirFiles\Slic3r" -Destination "$envProgramFiles" -Recurse

		#Create Shortcuts
				Copy-File -Path "$dirSupportFiles\Slic3r.lnk" -Destination "$envPublic\Desktop"
		...
		#Disable Updates Current Users / Default User
				Get-ChildItem -Path "${envSystemDrive}\Users" -Force | Where-Object {$_.PSIsContainer -eq $True} | ForEach-Object {
						...
						If ((Test-Path $UserRoamFolder) -eq $false) {
								Copy-File -Path "$dirSupportFiles\Slic3r\slic3r.ini" -Destination "$UserRoamFolder"
						}
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		#Uninstall Slic3r
		Remove-File -Path "$envProgramFiles\Slic3r" -Recurse

		#Create Shortcuts
				Remove-File -Path "$envPublic\Desktop\Slic3r.lnk"
				Remove-File -Path "$envProgramData\Microsoft\Windows\Start Menu\Programs\Slic3r.lnk"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU8BejVaM2scyHxyKKIWGT4aKR
# qAOgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFMV7RZGR815LS1LXY6MUGc+s6xjFMA0GCSqGSIb3DQEBAQUABIIBgFCBNaFo
# nPaTZguMXwDWk3pwBDDEG8uB4LAgmINtb/oPRK6ptXz3j3Ji0khz/ezP9slyKbaz
# QIkxOCz/nSVClj7fxH9sPtsmoHssOoCE+L5NAjGEfDmSOpKKoMCBUV8Cixs2WaOI
# e8UJKPj3lqGdD/skzwLK07hYSuOjDmQFhIT3aI6PCUqcAYIG51ikquk8Y/8T763x
# ibWc5WQDe2AUogausQ0MD11sBqM0XQuANfsaiz2B5DhCCmMP2WOH4io9p+KXs/5Q
# IKe+zgni7de0gxTLq/Ab9MkNKTXmTR8PW2yd1fgiYKOeC8Z3nQt9dTpO/96ewSO7
# IQMCR+mVYNQNhbI7LCBSVwJbCdemVU+Q3C61YytvTqSkhryikEu0l6L3pCzZqXkS
# +LNEeC8S+NvJGTRUHcgQxsOh3GBcKgsw5wNTdmUGrAFISGoVf/0s2diAllpJGOg3
# 48l32kWkJKpHEmOXkq/9OK24JDD4vdNWqFdn2zcJHTbzkwzLi0oeQiIOqA==
